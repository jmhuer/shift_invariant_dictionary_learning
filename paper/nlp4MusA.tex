...
\begin{figure*}[ht]
  ...
  \caption{After training the model we can use it to encode datapoints of arbitrary length unsupervised stylistic segmentation. e }
  \label{fig:boat1}
\end{figure*}
